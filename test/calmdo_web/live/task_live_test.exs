  ...
  describe "Index" do
    ...
    test "updates task in listing", %{conn: conn, task: task} do
      ...
      assert {:ok, form_live, _html} =
               index_live
               |> element("#tasks-started-#{task.id} a", "Edit")
               |> render_click()
    ...
    test "deletes task in listing", %{conn: conn, task: task} do
      ...
      assert index_live |> element("#tasks-started-#{task.id} a", "Delete") |> render_click()
      refute has_element?(index_live, "#tasks-started-#{task.id}")
    end
  end
